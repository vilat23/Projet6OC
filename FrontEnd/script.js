...
async function getWorks() {
    ...
    return reponse.json()
        ...
        .then(function (data) {
            console.log(data)
            for (works in data) {
                gallery.innerHTML += `<figure data-${data[works].category.name} class="active">
...
/* Ensuite on dit que lorsque l'etiquette correspond au dataset on remplace la class par active
